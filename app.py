...
# Estilos CSS limpios y corporativos
st.markdown("""
    <style>
...
st.markdown("<h2 style='text-align: center; color: #FFFFFF;'>🛡️ Diagnóstico de Soberanía Cognitiva e Inmunidad Operativa</h2>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; color: #94A3B8;'>Evalúa el riesgo de Amnesia Corporativa, Shadow AI y Fricción Operativa en tu organización.</p>", unsafe_allow_html=True)
st.markdown("---")
...
with st.form("diagnostic_form"):
    ...
    st.markdown("### 3. ⚙️ Test de Fricción Operativa (ERP / Aduanas)", help="Incluye gestión de Packing Lists, inventarios Odoo, etc.")
    q3 = st.radio(
...
if submit_button:
    # Lógica de puntuación y cálculo financiero estimado
    score = 0
    ...
    # Límite máximo de exposición 100%
    exposure = min(score, 95)
    
    # Estimaciones financieras basadas en el riesgo
    ...
    st.markdown("""
    ---
    ### 💎 Desbloquea el Resumen Ejecutivo & Plan de Blindaje (Living BlueBook)
    """)
    ...
    # Botón de pasarela de pago / agendamiento
    st.markdown("""
